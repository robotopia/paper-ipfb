...
\title[MWA tied-array processing IV]{MWA tied-array processing IV: Microsecond time resolution via PFB synthesis}
...
\author[McSweeney et al.]{S. J. McSweeney$^1$, S. M. Ord$^2$, D. Kaur$^1$, I. Morrison$^1$
...
The Murchison Widefield Array \citep[MWA;][]{Tingay2013} is a low-frequency ($\sim80$-$300\,$MHz) aperture array telescope situated in remote Western Australia.
Now in its second phase of development \citep[Phase II;][]{Wayth2018}, it consists of 256 `tiles' (sets of $4\times4$ cross-dipole antennas) distributed over an area roughly $5.3\,$km in diameter, 128 of which can be used at a single time to form an interferometer.
...
This system (with its accompanying implementation, described in further detail below) has enabled the MWA to be used as a premier instrument for high-time resolution studies of transient signals, especially pulsars \citep[e.g.][]{Oronsaye2015,McSweeney2017,Bhat2018}.
