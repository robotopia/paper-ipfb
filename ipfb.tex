...
Because the FPGA-based fine PFB was used in this test, the errors shown in Fig. \ref{fig:compare_timeseries} do not contain any replication error.
Without replication error, it is readily apparent that the analysis-synthesis pair is able to reproduce the noise remarkably well.
