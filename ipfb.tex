...
After low-noise filtering and digitising the raw signal, they are subject to a two-stage frequency analysis filter, which trades time resolution for increased frequency resolution.
